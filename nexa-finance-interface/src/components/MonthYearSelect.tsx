  ...
  return (
    <div className="flex items-center justify-between bg-gray-900 rounded-lg p-3 border border-gray-700">
      ...
      <div className="flex gap-3">
        ...
        <select
          id="month-select"
          className="bg-gray-800 border border-gray-700 rounded-md px-3 py-1 text-sm font-medium text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
          value={month}
